...
Every action appears below with its English and Chinese text, its risk level, and
...
| 🔴 **high / 高** | Removes a program or blocks a capability. Never part of the default selection. |
...
- **Risk / 风险:** 🟢 low / 低  ·  **Target / 类型:** `registry`  ·  **Default / 默认:** yes / 是
...
- **Risk / 风险:** 🟢 low / 低  ·  **Target / 类型:** `registry`  ·  **Default / 默认:** no / 否
...
- **Risk / 风险:** 🟡 medium / 中  ·  **Target / 类型:** `registry`  ·  **Default / 默认:** no / 否
...
- **Risk / 风险:** 🟢 low / 低  ·  **Target / 类型:** `service`  ·  **Default / 默认:** yes / 是
...
- **Risk / 风险:** 🟡 medium / 中  ·  **Target / 类型:** `service`  ·  **Default / 默认:** no / 否
...
- **Risk / 风险:** 🟢 low / 低  ·  **Target / 类型:** `task`  ·  **Default / 默认:** yes / 是
...
- **Risk / 风险:** 🟢 low / 低  ·  **Target / 类型:** `task`  ·  **Default / 默认:** no / 否
...
- **Risk / 风险:** 🟢 low / 低  ·  **Target / 类型:** `appx`  ·  **Default / 默认:** no / 否
...
- **Risk / 风险:** 🟡 medium / 中  ·  **Target / 类型:** `appx`  ·  **Default / 默认:** no / 否
...
- **Risk / 风险:** 🔴 high / 高  ·  **Target / 类型:** `onedrive`  ·  **Default / 默认:** no / 否
...
- **Risk / 风险:** 🟡 medium / 中  ·  **Target / 类型:** `path-clean`  ·  **Default / 默认:** yes / 是

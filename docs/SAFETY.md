...
2. **Know what you use.** If you rely on Game Bar recording, Phone Link, the new Outlook, Sticky Notes, Microsoft To Do, or OneDrive, leave those actions off. They are all in the `aggressive` preset and all individually skippable.
